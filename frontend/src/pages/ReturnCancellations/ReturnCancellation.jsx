...
const ReturnCancellation = () => {
  return (
    <main className="policy-content px-6 md:px-16 lg:px-24 py-12 text-justify text-gray-800">
      <h1 className="text-3xl font-bold mb-6">Return and Cancellation Policy</h1>
      <p className="italic text-sm mb-4">Effective Date: W.E.F. 20th July 2025</p>

      <div className="terms-section prose max-w-none">
        <p>
        ...
        <ul>
          <li><strong>Email:</strong> <a href="mailto:info@wildbynature.co.in" className="text-blue-600 underline">info@wildbynature.co.in</a></li>
